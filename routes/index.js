...
module.exports = function(app) {
  ...
  app.get('/play', Tagcontroller.tagsByRedis, MovieController.hotsByRedis, MovieController.play);
  app.get('/movie/:id/play', csrfProtection, Tagcontroller.tagsByRedis, MovieController.hotsByRedis, MovieController.play);
